        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="viewAccount.do"><i class="fa fa-fw fa-desktop"></i> View Portfolio</a>
                    </li>
                    <li>
                        <a href="researchFund.do"><i class="fa fa-fw fa-search"></i> Research Fund</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="history.do"><i class="fa fa-fw fa-table"></i> Transaction History</a>
                    </li>
                    <li>
                        <a href="requestCheck.do"><i class="fa fa-fw fa-edit"></i> Request Check</a>
                    </li>
                </ul>
            </div>
        </nav>
