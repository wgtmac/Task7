...
<div id="wrapper"> 
  ...
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="navbar-header"> <a href="employeeMain.do"> <img src="bootstrap/img/logo.png" alt="CFS Logo" border: 0; position: relative; top: 5px; left: 10px;> </a> </div>
    <!-- Top Menu Items -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav side-nav">
        <li> <a href="createEmployee.do"><em class="fa fa-fw fa-user"></em> Create Employee Account</a> </li>
